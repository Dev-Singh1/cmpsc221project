...
public class ScheduleQueries {
    ...
    public static ArrayList<ScheduleEntry> getWaitlistedStudentsByClass(String semester, String courseCode){
       ...
       try
       {
           getWaitStudents = connection.prepareStatement("select * from app.schedule where app.schedule.coursecode=(?) and app.schedule.semester=(?) and app.schedule.status=(?) order by app.schedule.timestamp");
